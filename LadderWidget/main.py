...
class ValueLadder(QWidget):
    ...
    the ValueLadder will set the value.  The value ladder
    ...
    def __init__(
        ...
        self.middle_widget = LadderMiddleWidget(
            value=0,
            height=WIDGET_HEIGHT,
            width=WIDGET_WIDTH
        )
...
class LadderMiddleWidget(QLabel):
    '''
    ...
    def __init__(self, parent=None, height=50, value=None, width=100):
        super(LadderMiddleWidget, self).__init__()
        self.setValue(value)
